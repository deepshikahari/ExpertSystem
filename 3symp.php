...
<style>
body{
	background-image: url("./images/symp.jpg");
   height: 100%; 
...
<div align='center'><select name="symptom2"></div>
  <option value="headache">headache </option>
  <option value="chill an shivering">chill and shivering</option>
   <option value="cold">cold </option>
   <option value="sneezing">sneezing </option>
   <option value="stomachpain">stomachpain </option>
   <option value="acid reflux">acid reflux </option>
...
<br><br>
<div align='center'>please select the symptom3:<br></div>
<div align='center'><select name="symptom3"></div>
  <option value="headache">headache </option>
  <option value="chill and shivering">chill and shivering</option>
   <option value="cold">cold </option>
   <option value="sneezing">sneezing </option>
