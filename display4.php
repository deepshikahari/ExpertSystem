...
session_start();
include "db1.php";
$symptom1 = $symptom2 = $syptom3 = $symptom4 = "";
$symptom1=trim($_POST["symptom1"]);
$symptom2=trim($_POST["symptom2"]);
$symptom3=trim($_POST["symptom3"]);
$symptom4=trim($_POST["symptom4"]);
$x=mysqli_query($conn,"select * from new where symptom='$symptom1' or symptom='$symptom2' or symptom='$symptom3' or symptom='$symptom4'");
